...
public class MoniKitMetricsPropertiesAutoConfiguration {

    private static final Logger logger = LoggerFactory.getLogger(MoniKitMetricsPropertiesAutoConfiguration.class);
    private final MoniKitMetricsProperties props;

    public MoniKitMetricsPropertiesAutoConfiguration(MoniKitMetricsProperties props) {
        this.props = props;
    }

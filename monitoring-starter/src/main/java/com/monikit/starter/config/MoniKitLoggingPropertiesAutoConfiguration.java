...
public class MoniKitLoggingPropertiesAutoConfiguration {

    private static final Logger logger = LoggerFactory.getLogger(MoniKitLoggingPropertiesAutoConfiguration.class);
    private final MoniKitLoggingProperties props;

    public MoniKitLoggingPropertiesAutoConfiguration(MoniKitLoggingProperties props) {
        this.props = props;
    }
